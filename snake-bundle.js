...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  loadSprite("pizza", "assets/sprites/pizza.png");
  loadSprite("background", "assets/sprites/background.png");
  loadSprite("fence-top", "assets/sprites/fence-top.png");
  loadSprite("fence-bottom", "assets/sprites/fence-bottom.png");
  loadSprite("fence-left", "assets/sprites/fence-left.png");
  loadSprite("fence-right", "assets/sprites/fence-right.png");
  loadSprite("post-top-left", "assets/sprites/post-top-left.png");
  loadSprite("post-top-right", "assets/sprites/post-top-right.png");
  loadSprite("post-bottom-left", "assets/sprites/post-bottom-left.png");
  loadSprite("post-bottom-right", "assets/sprites/post-bottom-right.png");
  loadSprite("snake-skin", "assets/sprites/snake-skin.png");
  add([
    sprite("background"),
    layer("background")
  ]);
